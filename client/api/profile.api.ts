...
import { createAuthHeaders, createFormDataHeaders, validateResponse } from '../lib/api-utils';
...
export function useUploadAvatar() {
    ...
    return useMutation({
        ...
        onSuccess: (result) => {
            ...
            queryClient.setQueryData(['profile', session?.user?.id], (oldData: Profile | undefined) => 
