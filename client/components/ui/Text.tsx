...
export const DisplayText: React.FC<Omit<ThemedTextProps, 'variant'> & { size?: 'large' | 'medium' | 'small' }> = ({
    size = 'medium',
    ...props
}) => (
...
export const HeadlineText: React.FC<Omit<ThemedTextProps, 'variant'> & { size?: 'large' | 'medium' | 'small' }> = ({
    size = 'medium',
    ...props
}) => (
...
export const TitleText: React.FC<Omit<ThemedTextProps, 'variant'> & { size?: 'large' | 'medium' | 'small' }> = ({
    size = 'medium',
    ...props
}) => (
    <Text variant={`title${size.charAt(0).toUpperCase() + size.slice(1)}` as TextVariant} {...props} />
);

export const BodyText: React.FC<Omit<ThemedTextProps, 'variant'> & { size?: 'large' | 'medium' | 'small' }> = ({
    size = 'medium',
    ...props
}) => (
...
export const LabelText: React.FC<Omit<ThemedTextProps, 'variant'> & { size?: 'large' | 'medium' | 'small' }> = ({
    size = 'medium',
    ...props
}) => (
...
export const CaptionText: React.FC<Omit<ThemedTextProps, 'variant'>> = (props) => (
    <Text variant="caption" {...props} />
);

export const OverlineText: React.FC<Omit<ThemedTextProps, 'variant'>> = (props) => (
