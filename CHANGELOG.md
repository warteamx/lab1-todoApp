...
## ✨ New Features
- [`247d562`](https://github.com/warteamx/lab1-todoApp/commit/247d562)  feat(client): Toggle task  filter button 
- [`2787805`](https://github.com/warteamx/lab1-todoApp/commit/2787805)  feat(client): set default filters to day view and pending status 
- [`d6c3568`](https://github.com/warteamx/lab1-todoApp/commit/d6c3568)  feat(api): enhance error handling for todo creation and fetching 

## 🐛 Bug Fixes
- [`eac4e88`](https://github.com/warteamx/lab1-todoApp/commit/eac4e88)  fix(app): fix data for client and server

# [v1.4.1](https://github.com/warteamx/lab1-todoApp/compare/v1.4.0...v1.4.1) (2026-07-31)

# [v1.4.0](https://github.com/warteamx/lab1-todoApp/compare/v1.3.2...v1.4.0) (2026-07-25)

## ✨ New Features
- [`84a6ac2`](https://github.com/warteamx/lab1-todoApp/commit/84a6ac2)  feat(skills): add ai skills to repo

# [v1.3.2](https://github.com/warteamx/lab1-todoApp/compare/v1.3.1...v1.3.2) (2026-07-21)

## 🐛 Bug Fixes
- [`c69402d`](https://github.com/warteamx/lab1-todoApp/commit/c69402d)  fix(husky): add support for new gitmoji in commit message validation

# [v1.3.1](https://github.com/warteamx/lab1-todoApp/compare/v1.3.0...v1.3.1) (2026-07-18)

## 🐛 Bug Fixes
- [`ef5a7e7`](https://github.com/warteamx/lab1-todoApp/commit/ef5a7e7)  fix(ci): add manual force deploy override for workflow dispatch
...
## 🐛 Bug Fixes
- [`6bbb068`](https://github.com/warteamx/lab1-todoApp/commit/6bbb068)  fix(aws): Add ssl certificate to EC2 + nginx

# [v1.2.10](https://github.com/warteamx/lab1-todoApp/compare/v1.2.9...v1.2.10) (2025-09-17)

## 🐛 Bug Fixes
- [`addf90e`](https://github.com/warteamx/lab1-todoApp/commit/addf90e)  fix(server): fix server ci version on healthcheck

# [v1.2.9](https://github.com/warteamx/lab1-todoApp/compare/v1.2.8...v1.2.9) (2025-09-17)

## 🐛 Bug Fixes
- [`4175460`](https://github.com/warteamx/lab1-todoApp/commit/4175460)  fix(ci): release step before building
